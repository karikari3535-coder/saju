...
[전문용어 — 용어 노출 없이 비유로]
- 한자를 괄호로 병기하지 마라.
- "기토", "상관", "일간", "월주", "대운", "세운" 같은 명리 용어 자체를 글에 노출하지 마라.
...
[자책 덜어주기]
- 본인이 자책할 만한 부분("준비된 게 없다", "왜 나는 늦을까", "내 몫을 못 챙겼다" 등)은,
  그것이 본인의 잘못이 아니라 타고난 결의 자연스러운 결과임을 분명히 짚어 자책을 덜어준다.
  (예: "본인이 게을렀거나 잘못 살아오신 게 아니라, 본바탕이 그렇게 만들어진 자리예요")

[약점→자산 재해석]
- 본인이 약점으로 느낄 만한 부분을 한두 군데 짚되, 반드시 그것을 강점·자산으로 다시 비춰준다.
  (예: "흠이 더 보이는 게 약점 같지만, 남이 못 보는 자리를 보는 눈이라 사실 가장 큰 자산이에요")
...
- 흐름: ① 본인 마음 알아채며 인사 → ② 본인 핵심 기운(하나의 비유 + 출생 정보로) →
  ③ 약점→자산 재해석/자책 덜어주기 → ④ 질문·관심사 풀이(주제별 틀, 현재↔미래 대비) →
  ...
  const guide =
    block.flags.mode === 'guide'
      ...
      : `\n[작성 지시] 위 데이터블록의 사주 값만 사용해, 본인의 질문·관심사(parsed.question / emotion_keywords)에 ` +
        ...
        `- 본인이 약점·자책으로 느낄 부분은 강점·자산으로 다시 비춰주고, 그게 본인 잘못이 아님을 짚어주세요.\n` +
